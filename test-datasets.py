...
# /Users/ahmedmostafa/Downloads/mad-from-scratch-main/LinearRegression/LinearRegression.py
...
def test(dataset, plot=True):
    ...
    plt.tight_layout()
    plt.savefig(f'/Users/ahmedmostafa/Downloads/mad-from-scratch-main/LinearRegression/data/our-result-{dataset}.png')
...
def test_learning_rate(dataset, plot=True):
    ...
    x = df[:, 0:-1]
    y = df[:, -1]
    x_train, x_test, y_train, y_test = train_test_split(x, y, shuffle=True, random_state=41)
    ...
    ax.legend()
    plt.tight_layout()
    plt.savefig('/Users/ahmedmostafa/Downloads/mad-from-scratch-main/LinearRegression/data/diff-learning-rates.png')
